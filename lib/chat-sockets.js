...
function transformText(text) {
  var trimmed = text.slice(0, 250)
    , entities =
        twitterText.extractEntitiesWithIndices(trimmed, { extractUrlsWithoutProtocol: true})
  var linkified = twitterText.autoLinkEntities(trimmed, entities, {
