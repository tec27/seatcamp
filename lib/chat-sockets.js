...
export default function(io, userIdKey, meatspaceProxy, ffmpegRunner, historyLimit,
    historyExpiryMs) {
  return new ChatSockets(io, userIdKey, meatspaceProxy, ffmpegRunner, historyLimit, historyExpiryMs)
}
